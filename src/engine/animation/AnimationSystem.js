...
export class AnimationSystem {
    animDefs = new Map();
    registerAnimation(unitId, action, def) {
        if (!this.animDefs.has(unitId))
            this.animDefs.set(unitId, new Map());
